class PlayerSerializer < ActiveModel::Serializer
  attributes :id, :name
  # , :nationality, :club_name, :club_position, :club_kit, :rating, :height, :weight, :preferred_foot, :birth_date, :age, :work_rate, :weak_foot, :skill_moves, :ball_control, :dribbling, :marking, :sliding_tackle, :standing_tackle, :aggression, :reactions, :attacking_position, :interceptions, :vision
